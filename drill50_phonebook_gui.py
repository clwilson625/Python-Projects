...
def load_gui (self):
      ...
      self.lbl_lname.grid(row=2, column=0, padx=(27,0), payd=(10,0), sticky=N+W)
      ...
      self.btn_update = tkButton(self.master, width=12, height=2, text='Update', command=lambda: phonebook_func.onUpdate(self))
